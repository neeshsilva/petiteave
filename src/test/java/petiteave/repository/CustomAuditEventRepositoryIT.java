...
import petiteave.config.audit.AuditEventConverter;
import petiteave.domain.PersistentAuditEvent;
...
import static petiteave.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
